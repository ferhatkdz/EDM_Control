...
{
   UART_OpenEx(uart, u32baudrate, UART_WORD_LEN_8, UART_PARITY_NONE, UART_STOP_BIT_1);
}
 ...
 *    @details      This function use to enable UART function and set baud-rate.
 */
void UART_OpenEx(UART_T* uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t  u32stop_bits)
{
